...
<html>
  ...
  <body>
    <div class="container">
    	...
    	<form method="post" id="loginForm">
    		<table>
    			...
    			<tr>
    				...
    				<td><input type="text" id="userName" name="userName" placeholder="Pleace input your name"></td>
    			</tr>
    			<tr>
    				<td class="right-label"><label for="userPassword">Password: &nbsp;</label></td>
    				<td><input type="password" id="userPassword" name="userPassword" placeholder="Please input your password"></td>
    			</tr>
    		</table>
        ...
        <br>
        <a href="findPassword.html">忘记密码？ 去找回</a>
    </div>
    <div class="logo">
        <table>
